...
# x_window = slide_MTS_tensor_step(train_data,0.1)  # x_window num_v,num_sub,window length,
window_size = get_window(dim_length)
#window_size = [int(0.1*dim_length), int(0.2*dim_length), int(0.3*dim_length)]
num_center_window = [int((3*900)/(6*dim_v)), int((2*900)/(6*dim_v)), int((1*900)/(6*dim_v))]
